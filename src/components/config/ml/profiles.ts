  ...
  mlflow: {
    ...
    sections: [
      ...
      },
      {
        ...
        fields: [
          {
            id: 'enableModelRegistry',
            label: 'Enable Model Registry',
            type: 'toggle',
        ...
        fields: [
          {
            ...
            type: 'toggle',
            description: 'Organize runs into experiments',
          },
        ],
      },
      {
        ...
        fields: [
          {
            ...
            type: 'toggle',
            description: 'Store model artifacts',
          },
          {
            id: 'artifactStore',
            label: 'Artifact Store',
            type: 'text',
            placeholder: 'file:///artifacts',
            description: 'URI for artifact storage',
          },
        ],
      },
      {
